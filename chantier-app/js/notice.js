...
const NOTICE_TEXT = {
  ...
  ro: {
    ...
    sections: [
      ...
      ['Ce date?', 'Numele, e-mailul și rolul dvs.; ora sosirilor și plecărilor și șantierul; o observație și o fotografie, dacă le adăugați; <strong>poziția GPS a telefonului doar în momentul exact al pontajului</strong> (niciodată continuu, niciodată în afara aplicației); kilometrii de acasă până la șantier și tipul vehiculului; rapoartele, fotografiile, problemele și achizițiile pe care le publicați.'],
  ...
  zh: {
    ...
    sections: [
      ...
      ['哪些数据？', '您的姓名、电子邮件和角色；您到达和离开的时间及工地；您添加的备注和照片；<strong>仅在您打卡的那一刻记录手机的 GPS 位置</strong>（绝不持续定位，绝不在应用之外定位）；您从家到工地的公里数和车辆类型；您发布的报告、照片、问题和采购记录。'],
